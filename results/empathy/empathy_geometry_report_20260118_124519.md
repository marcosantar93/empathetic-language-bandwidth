# Empathy Geometry: Measuring Bandwidth Across Language Models
...
We investigate the geometric properties of empathetic representations in large 
language models by measuring "empathetic bandwidth" — the product of subspace 
dimensionality and steering range. Across five open-weight models (Llama-3.1-8B, 
Qwen2.5-7B, Mistral-7B, Gemma2-9B, DeepSeek-R1-7B), we find:
...
"truthfulness" or "toxicity"). For complex attributes like empathy, we hypothesize 
that models utilize **multi-dimensional subspaces** with varying steering ranges.

### Research Question

**Do different language models encode empathy with different geometric bandwidth?**
...
*Report generated on January 18, 2026 at 12:45:19*
